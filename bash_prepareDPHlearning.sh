										...
										do
											for dpcostreductionret in 0.7 0.85
 											do
												...
												do
													julia threeplsp.jl --inst instances/N${N}T${T}/N${N}T${T}P${P}W${W}${V}${id}.dat --form ${model} --capacity ${cap} --balanced ${bal} --dpalpha ${dpalpha} --dpredperiods ${dpredperiods} --dpcostreductionred ${dpcostreductionret} --dpcostreductionware ${dpcostreductionware}
												done
											done
										done
									done								
